...
class OrientationState extends ChamberState
{
	...
	override public function create():Void
	{
		...
		tv.addAnimation("talking",[1,1,2,1,2,1,2,2,1,1,1,2,1,2,1,2],10,true);
		tv.addAnimation("off",[0,0],10,true);
		tv.addAnimation("not talking",[1,1],10,true);
		tv.play("off");
	...
	override public function handleMessageInput():Bool
	{
		...
		else if (state == WRAP_MESSAGE && FlxG.keys.justPressed("ENTER"))
		{
